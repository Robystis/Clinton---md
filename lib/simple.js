    ...
    async value (jid, buffer, contentText, footerText, button1, id1, quoted, options) {
        ...
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
            ...
            return await conn.sendMessage(jid, buttonMessage, { quoted, forwardingScore: 99999, isForwarded: true, ...options })
        }
    },
    send2ButtonImg: {
...
let type = await conn.getFile(buffer);
    ...
    sendBut: {
        async value (jid, content, footerText, button1, id1, quoted, options) {
                ...
                conn.sendMessage(jid, buttonMessage, { quoted, forwardingScore: 999999, isForwarded: true, ...options })
            }
        },
        send2Button: {
        ...
        async value (jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
                ...
                conn.sendMessage(jid, buttonMessage, { quoted, forwardingScore: 99999, isForwarded: true, ...options })
            }
        },
        /**
    *status 
    */
    ...
    async value(status) {
        ...
        sendButtonDoc: {   
             ...
             * @param {Object} options 
             */
            async value (jid, content, footerText, filename, button1, id1, quoted, options) {
              const buttons = [
                { buttonId: id1, buttonText: { displayText: button1 }, type: 1 }
              ]
              const buttonMessage = {
            ...
            send2ButtonDoc: {   
                 ...
                 * @param {Object} options 
                 */
                async value (jid, content, footerText, filename, button1, id1, button2, id2, quoted, options) {
                  const buttons = [
                    { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
                    { buttonId: id2, buttonText: { displayText: button2 }, type: 1 }
                  ]
                  const buttonMessage = {
                    document: { url: "https://wa.me/254735342808" },
                    mimetype: global.doc,
                    fileName: filename,
                    fileLength: 9999,
                    pageCount: 999,
                ...
                send3ButtonDoc: {   
                     ...
                     * @param {Object} options 
                     */
                    async value (jid, content, footerText, filename, button1, id1, button2, id2, button3, id3, quoted, options) {
                      const buttons = [
                        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
                        { buttonId: id2, buttonText: { displayText: button2 }, type: 1 },
                        { buttonId: id3, buttonText: { displayText: button3 }, type: 1 }
    ...
    */
        ...
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
            ...
            if (e.json) throw e.json;
                ...
                const buttons = [
                    { index: 1, urlButton: { displayText: dtu, url: sig } },
    ...
    send3TemplateButtonImg: {
        ...
        sendTemplateButtonFakeImg: {
            async value (jid, buffer, content, footerText, btn1, id1, quoted, options) {
                    let type = await conn.getFile(buffer);
        let { res, data: file } = type;
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
            ...
            if (e.json) throw e.json;
                    ...
                    conn.sendMessage(jid, key, { quoted, forwardingScore: 99999, isForwarded: true, ...options })
                }
        ...
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
            ...
            if (e.json) throw e.json;
                    ...
                    conn.sendMessage(jid, key, { quoted, forwardingScore: 9999, isForwarded: true, ...options })
                }
            },
    ...
    */
                    ...
                    send2TemplateButtonDoc: { 
                       async value (jid, buffer, content, footerText, button1, id1, button2, id2, quoted, options) {
                               const buttons = [
                                   { index: 1, urlButton: { displayText: dtu, url: sig } },
                                   { index: 2, callButton: { displayText: dtc,  phoneNumber: phn } },
                                   { index: 3, quickReplyButton: { displayText: button1, id: id1 } },
                                   { index: 4, quickReplyButton: { displayText: button2, id: id2 } }
                               ]
                               const buttonMessage = {
                                   document: { url: "https://wa.me/254735342808"},
                                   mimetype: global.doc,
                       ...
                       send3TemplateButtonDoc: { 
                        async value (jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
                                const buttons = [
                                    ...
                                    { index: 3, quickReplyButton: { displayText: button1, id: id1 } },
                                    { index: 4, quickReplyButton: { displayText: button2, id: id2 } },
                                    { index: 5, quickReplyButton: { displayText: button3, id: id3 } }
                                ]
                                const buttonMessage = {
                                    document: { url: "https://wa.me/254735342808"},
                                    mimetype: global.doc,
        ...
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
            ...
            if (e.json) throw e.json;
                                ...
                                }), { userJid: conn.user.jid, quoted: quoted, forwardingScore: 99999, isForwarded: true, ...options });
        ...
        send2TemplateButtonLoc: {
                            async value (jid, buffer, contentText, footer, buttons1, row1, buttons2, row2, quoted, options) {
                                    let type = await conn.getFile(buffer);
        let { res, data: file } = type;
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
           ...
           send3TemplateButtonLoc: {
                            async value (jid, buffer, contentText, footer, buttons1, row1, buttons2, row2, buttons3, row3,  quoted, options) {
                                    let type = await conn.getFile(buffer);
        let { res, data: file } = type;
        if ((res && res.status !== 200) || file.length <= 65536) {
          try {
                     ...
                     */
                        sendButtonImgDoc: { 
                            async value (jid, buffer, contentText, footerText, button1, id1, quoted, options) {
                                    ...
                                    const buttonMessage = {
                                        image: await(await fetch(buffer)).buffer(),
                                        document: { url: "https://wa.me/254735342808"},
                                        mimetype: global.doc,
                                        fileName: global.ucapan,
                                        fileLength: 9999,
